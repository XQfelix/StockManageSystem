...
<body class="easyui-layout">
	<div region="north" style="height:132px; background-color:#E0ECFF;">
		...
		<div style="padding-top:50px;padding-right:20px;">当前用户：<font color="red" size="10px">${currentUser.userName }</font>
			<a href="stockManageSystem/login!logOut">>><font color="red" >退出</font></a>
		</div>
	</div>
	
	<div region="west" style="width:200px;" title="导航" split="true">
		<ul id="tree">
	...
	<div region="center" class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" >
			...
			<div align="center" style="padding-top: 100px;"><font color="red" size="8"></font>
			<div id="stockcenter"><img src="images/center.jpg"></div>
