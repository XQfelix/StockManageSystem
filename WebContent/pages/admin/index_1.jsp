		...
		<form action="stockManageSystem/login!login" method="post">
			<table border="0px" width="1321" height="585" >
				...
				<tr height="20">
					...
					<td width="5%">&nbsp;<font color="white">用户名：</td>
					<td width="10%"><input type="text" value="${user.userName }" name="user.userName" id="userName" size="17" height="20"/></td>
					<td width="50%"><font color="red">${error }</font></td>
				</tr>
				<tr>
			  <tr height="95">
                    <td width="35%" height="23"></td>
                    <td width="5%">&nbsp;<font color="white">密     码：</td>
				...
				<tr height="10">
                    <td width="67.7%" height="23"></td>
                    <td width="5%">&nbsp;<font color="white">验证码：</td>
